...
/**
 * Standard-Implementierung für die Verwaltung von Bildern in AWS S3.
 * <p>
 * Diese Klasse bietet die ursprüngliche S3-basierte Implementierung:
...
public class StandardImageService implements ImageService {
    ...
    private static final Logger log = LoggerFactory.getLogger(StandardImageService.class);
    ...
    /**
     * Konstruktor für StandardImageService.
     *
     ...
     */
    public StandardImageService(S3Client s3Client, S3Presigner s3Presigner, ImageProperties imageProperties) {
